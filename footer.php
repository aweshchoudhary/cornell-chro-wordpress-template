...
<div class="overlay fixed bottom-0 left-0 z-[999] w-full bg-white/85 py-5 flex justify-center backdrop-blur">
    <a href="/#get-brochure" class="text-white hover:text-white/80 block px-5 font-medium uppercase py-2.5 rounded bg-[#C60000] text-white w-fit text-center">Download Brochure</a>
</div>
...
<footer class="md:p-20 px-5 md:py-20 py-10 mb-20 bg-primary text-white flex flex-wrap gap-5">
    ...
    <div class="md:basis-1/4 basis-full flex-1 gap-5">
        ...
        <div class="flex items-start gap-5 mt-10">
            ...
            <div>
                <h3 class="text-2xl mb-1 font-semibold">Singapore</h3>
                <p>80 Robinson Road #15-02, <br>
                    Singapore, 068898 </p>
            </div>
        </div>
    </div>
    <div class="md:basis-1/4 basis-full flex-1 gap-5">
        ...
        <div class="flex items-start gap-5 mt-10">
            ...
            <div>
                ...
                <p>Le Cygne Commercial Center 2, <br>
                    6th FloorAl-Arz, <br>
        ...
        <div class="flex items-start gap-5 mt-10">
            ...
            <div>
                <h3 class="text-2xl mb-1 font-semibold">India</h3>
                <p>7th Floor, Capital Building, G-Block,
